...
export const query = graphql`
  {
    ...
    hero: markdownRemark(
      fileAbsolutePath: { regex: "/content/sections/hero/" }
    ) {
      frontmatter {
        introduction
        tagline
    ...
    about: markdownRemark(
      fileAbsolutePath: { regex: "/content/sections/about/" }
    ) {
      frontmatter {
        title
        techs
    ...
    cards: markdownRemark(
      fileAbsolutePath: { regex: "/content/sections/cards/" }
    ) {
      frontmatter {
        cards {
          label
    ...
    contact: markdownRemark(
      fileAbsolutePath: { regex: "/content/sections/contact/" }
    ) {
      frontmatter {
        phone
        email
