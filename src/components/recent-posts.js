...
const RecentPosts = ({ data }) => {
  ...
  const recentPosts = data.map((post, index) => {
    ...
    const links = ["https://medium.com/javascript-in-plain-english/17-killer-websites-for-web-developers-13e1e30345b8","https://blog.bitsrc.io/5-methods-to-persisting-state-between-page-reloads-in-react-8fc9abd3fa2f", "https://medium.com/better-programming/dont-use-if-else-and-switch-in-javascript-use-object-literals-c54578566ba0", "https://medium.com/javascript-in-plain-english/testing-non-exported-functions-in-javascript-8644966c52e6"]
